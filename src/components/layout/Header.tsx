  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--border)] bg-[rgba(13,17,23,0.95)] backdrop-blur-lg">
      <div className="mx-auto flex h-18 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="#" className="flex items-center gap-2" aria-label="NetConnect home">
          <Wifi className="size-6 text-[var(--accent)]" />
          <span className="text-xl font-black tracking-tight text-white">NetConnect</span>
        </Link>
